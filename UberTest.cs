...
using TestUber._1.Entidade;
using TestUber._2.Serviços;
using TestUber._3.PageObject;
   ...
   public class UberTest
    {
        ...
        public void ObterDatos()
        {
            ...
            //Login
            page.InserirEmail("DIGITE AQUI SEU EMAIL", "useridInput");
            page.ClicarNoBotaoXPath("/html/body/div[1]/div/div/div/div[1]/form/div[2]/button"); ;
            page.InserirSenha("password", "DIGITE AQUI SUA SENHA");
